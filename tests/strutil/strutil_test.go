...
func TestNormalize(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			result := strutil.Normalize(tt.input)
...
func TestContainsFold(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.s+"/"+tt.substr, func(t *testing.T) {
			result := strutil.ContainsFold(tt.s, tt.substr)
			if result != tt.expected {
...
func TestTokens(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			result := strutil.Tokens(tt.input)
...
func TestCanonURL(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			result := strutil.CanonURL(tt.input)
			if result != tt.expected {
...
func TestSHA16(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.input, func(t *testing.T) {
			result := strutil.SHA16(tt.input)
			if len(result) != 16 {
				t.Errorf("SHA16(%q) length = %d, want 16", tt.input, len(result))
			}
			// Test consistency
			result2 := strutil.SHA16(tt.input)
			if result != result2 {
...
func TestHasPathPrefixSafe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.path+"/"+tt.prefix, func(t *testing.T) {
			result := strutil.HasPathPrefixSafe(tt.path, tt.prefix)
			if result != tt.expected {
